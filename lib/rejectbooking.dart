...
class rejectbooking extends StatefulWidget {
  @override
  _rejectbookingState createState() => _rejectbookingState();
}
...
class _rejectbookingState extends State<rejectbooking> {
  ...
  Future<void> SendRequest() async {
    String ApiAddress =
        "https://theeasylearnacademy.com/saloon/get_rejected_booking.php";
    print(ApiAddress);
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: DefaultTabController(
        ...
        child: Scaffold(
          appBar: AppBar(
            title: Text('Rejected Appointment Bookings'),
          ),
          body: Padding(
